...
public class CountWordsTest {
    @Test
    public void testCountWordsHappyPathTest(){
        String text = "As of March 2022, Java 18 is the latest version," +
                ...
                "for commercial java use, although it will otherwise still support Java 8 with public updates" +
                " for personal use indefinitely. " +
